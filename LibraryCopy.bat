...
xcopy /s /y  /exclude:Engine_exclude_list.txt ".\External\Library\PhysX\*.dll" ".\OutputFile\bin"
xcopy /s /y  /exclude:Engine_exclude_list.txt ".\External\Library\FBXLoader\*.dll" ".\OutputFile\bin"
