...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_AllowOverlap         = 1 << 2,   // Hit02 testing to allow subsequent widgets to overlap this one
...
enum ImGuiSelectableFlags_
{
    ...
    ImGuiSelectableFlags_AllowOverlap       = 1 << 4,   // (WIP) Hit02 testing to allow subsequent widgets to overlap this one
