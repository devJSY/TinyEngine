...
void CMonsterUnitScript::LandingSmokeEffect(Vec3 _vOffset)
{
    ...
    pLandingSpawn->Transform()->SetWorldPos(Transform()->GetWorldPos() + _vOffset);
...
void CMonsterUnitScript::BodyAttackSound()
{
    ...
    if (nullptr != pTr)
    {
        GamePlayStatic::Play2DSound(L"sound\\wav\\CharaBasic\\0003.wav", 1, 0.2f);
    }
}
...
void CMonsterUnitScript::FindSound()
{
    ...
    if (nullptr != pTr)
    {
        GamePlayStatic::Play2DSound(L"sound\\wav\\CharaBasic\\0017.wav", 1, 0.1f);
    }
}
